...
export const _fetchHawalaBranchList = (page: number = 1,search:string='') => async (dispatch: Dispatch) => {
  ...
  try {
    ...
    dispatch({
      type: FETCH_HAWALA_BRANCH_LIST_FAIL,
...
// Add hawala
export const _addHawalaBranch = (newData: any, toast: React.RefObject<Toast>) => async (dispatch: Dispatch) => {
  ...
  try {
    ...
    toast.current?.show({
      severity: "success",
      summary: "Successful",
      detail: "Hawala Branch added successfully",
      life: 3000,
    });
  } catch (error: any) {
    dispatch({
        type: ADD_HAWALA_BRANCH_FAIL,
        payload: error.message,
    });

    let errorMessage = "Failed to update Hawala Branch"; // Default message
...
// Edit hawala
export const _editHawalaBranch = (hawalaId: number, updatedData: any, toast: React.RefObject<Toast>) => async (dispatch: Dispatch) => {
  ...
  try {
    ...
    dispatch({
      type: EDIT_HAWALA_BRANCH_SUCCESS,
      payload: newData,
    });
    toast.current?.show({
      severity: "success",
      summary: "Successful",
      detail: "Hawala Branch updated successfully",
      life: 3000,
    });
  } catch (error: any) {
    dispatch({
      type: EDIT_HAWALA_BRANCH_FAIL,
      payload: error.message,
    });
    toast.current?.show({
      severity: "error",
...
export const _deleteHawalaBranch = (hawalaId: number, toast: React.RefObject<Toast>) => async (dispatch: Dispatch) => {
  ...
  try {
    ...
    dispatch({
      type: DELETE_HAWALA_BRANCH_SUCCESS,
      payload: hawalaId,
    });
    toast.current?.show({
      severity: "success",
    ...
    dispatch({
      type: DELETE_HAWALA_BRANCH_FAIL,
      payload: error.message,
    });
    toast.current?.show({
      severity: "error",
      summary: "Error",
      detail: "Failed to delete Hawala Branch",
      life: 3000,
    });
  }
};
